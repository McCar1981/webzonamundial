          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section className="p-8 rounded-3xl bg-white/[0.02] border border-white/10">
              ...
              <p className="text-gray-400 leading-relaxed">
                {teamAny.clasificacion || `${team.nombre} ${team.esAnfitrion ? 'se clasificó automáticamente como uno de los países anfitriones del Mundial 2026' : `obtuvo su plazal para el Mundial 2026 a través del proceso clasificatorio de ${team.confederacion}`}.`}
              </p>
            </section>
