// LigasBanner — el puente del home a Zona de Ligas (fútbol de clubes todo el año).
// Mismo patrón visual que CalendarBanner/BracketBanner para coherencia de marca.
// Estático, sin fetch ni JS de estado: cero riesgo de rendimiento.

"use client";

import Link from "next/link";

export function LigasBanner() {
  return (
