...
const CREATOR_ICONS = ["streaming","streaming","streaming","creadores","match center","creadores"];
const CHAT_FEAT_ICONS = ["micro-predicciones","predicciones","predicciones","ranking","micro-predicciones"];
const REWARD_ICONS = ["formato 2026","micro-predicciones","streaming","streaming"];
const WATCH_FEAT_ICONS = ["match center","chat en vivo","predicciones","ranking"];
    ...
    <div style={{ background: BG, color: "#fff", fontFamily: "'Outfit',sans-serif", minHeight: "100vh" }}>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontSize: "clamp(28px,5vw,42px)", fontWeight: 800 }}>
              <SvgIcon name="streaming" size={32} style={{display:"inline-block",verticalAlign:"middle"}} /> {sT.creatorsSectionTitle} <span style={{ color: GOLD }}>{sT.creatorsSectionTitleHighlight}</span>
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: 20 }}>
            {creators.map((creator, i) => (
              <div key={i} style={{
                ...
                <div><SvgIcon name={creator.icon} size={32} /></div>
                <div>
      ...
      <section style={{ padding: "80px 20px", background: BG3 }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontSize: "clamp(28px,5vw,42px)", fontWeight: 800 }}>
              <SvgIcon name="chat en vivo" size={32} style={{display:"inline-block",verticalAlign:"middle"}} /> {sT.chatSectionTitle} <span style={{ color: GOLD }}>{sT.chatSectionTitleHighlight}</span>
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(200px,1fr))", gap: 16 }}>
            {chatFeatures.map((feature, i) => (
              <div key={i} style={{
                ...
                <div style={{ marginBottom: 12 }}><SvgIcon name={feature.icon} size={32} /></div>
      ...
      <section style={{ padding: "80px 20px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontSize: "clamp(28px,5vw,42px)", fontWeight: 800 }}>
              <SvgIcon name="micro-predicciones" size={32} style={{display:"inline-block",verticalAlign:"middle"}} /> {sT.rewardsSectionTitle} <span style={{ color: GOLD }}>{sT.rewardsSectionTitleHighlight}</span>
            </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(250px,1fr))", gap: 20 }}>
            {rewards.map((reward, i) => (
              <div key={i} style={{
                ...
                <div style={{ marginBottom: 12 }}><SvgIcon name={reward.icon} size={40} /></div>
      ...
      <section style={{ padding: "80px 20px", background: BG3 }}>
        <div style={{ maxWidth: 1000, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontSize: "clamp(28px,5vw,42px)", fontWeight: 800 }}>
              <SvgIcon name="formato 2026" size={32} style={{display:"inline-block",verticalAlign:"middle"}} /> {sT.modesSectionTitle} <span style={{ color: GOLD }}>{sT.modesSectionTitleHighlight}</span>
            </h2>
          </div>
      ...
      <section style={{ padding: "80px 20px", textAlign: "center" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          <div style={{ marginBottom: 24 }}><SvgIcon name="predicciones" size={48} style={{margin:"0 auto"}} /></div>
      ...
      <ModuleLandingExtras slug="streaming" />
    </div>
  )
}
