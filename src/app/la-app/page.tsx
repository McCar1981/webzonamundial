...
const MODULES=[
  {id:"predicciones",icon:"predicciones",title:"Predicciones",desc:"8 tipos de predicción para cada partido",color:"#c9a84c",gradient:"linear-gradient(135deg,#c9a84c20,#000000)"},
  {id:"fantasy",icon:"fantasy",title:"Fantasy Mundial",desc:"Arma tu 11 ideal y compite en el ranking global",color:"#00d4ff",gradient:"linear-gradient(135deg,#00d4ff15,#000000)"},
  {id:"ia-coach",icon:"ia coach",title:"IA Coach",desc:"Tu analista personal con inteligencia artificial",color:"#22c55e",gradient:"linear-gradient(135deg,#22c55e15,#000000)"},
  {id:"trivia",icon:"trivia",title:"Trivia Diaria",desc:"Preguntas de fútbol con puntos y ranking",color:"#f59e0b",gradient:"linear-gradient(135deg,#f59e0b15,#000000)"},
  {id:"modo-carrera",icon:"modo carrera",title:"Modo Carrera",desc:"Dirige una selección como DT virtual",color:"#ef4444",gradient:"linear-gradient(135deg,#ef444415,#000000)"},
  {id:"ligas",icon:"ligas privadas",title:"Ligas Privadas",desc:"Compite con amigos en tu propia liga",color:"#8b5cf6",gradient:"linear-gradient(135deg,#8b5cf615,#000000)"},
  {id:"streaming",icon:"streaming",title:"Zona Streaming",desc:"Directos con creadores durante los partidos",color:"#e879f9",gradient:"linear-gradient(135deg,#e879f915,#000000)"},
  {id:"rankings",icon:"ranking",title:"Rankings",desc:"Global, por país, por creador",color:"#06b6d4",gradient:"linear-gradient(135deg,#06b6d415,#000000)"},
  {id:"micro",icon:"micro-predicciones",title:"Micro-predicciones",desc:"Predicciones en vivo durante el partido",color:"#f97316",gradient:"linear-gradient(135deg,#f9731615,#000000)"},
  {id:"stories",icon:"stories",title:"Stories",desc:"Contenido editorial diario del Mundial",color:"#14b8a6",gradient:"linear-gradient(135deg,#14b8a615,#000000)"},
  {id:"chat",icon:"chat en vivo",title:"Chat por Liga",desc:"Chat en tiempo real durante los partidos",color:"#3b82f6",gradient:"linear-gradient(135deg,#3b82f615,#000000)"},
  {id:"matchcenter",icon:"match center",title:"Match Center",desc:"Cada partido en vivo con stats completas",color:"#10b981",gradient:"linear-gradient(135deg,#10b98115,#000000)"},
];
