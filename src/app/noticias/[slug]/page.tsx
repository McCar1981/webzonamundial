...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      tags: n.tags,
      // Note: og:image is auto-generated by opengraph-image.tsx in this folder
      // (dynamic per-article social card with headline + author + brand).
      // We do NOT set images here so Next.js wires the dynamic generator.
    },
    twitter: {
      card: "summary_large_image",
      title: n.title,
      description,
      // Same: twitter:image inherits from opengraph-image.tsx automatically.
    },
  };
}
