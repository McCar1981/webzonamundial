...
export default function RegistroCodigoCodeClient({ code, valid, label, rewardNewUser }: Props) {
  ...
  const c = isEN
    ? {
        ...
        invalidSub: "You can still create your account — you just won't get the code bonus. Or ask for a valid code.",
    ...
    : {
        ...
        invalidSub: "Puedes crear tu cuenta igualmente — solo que no recibirás el bono del código. O pide uno válido.",
