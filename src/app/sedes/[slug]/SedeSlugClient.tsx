...
// Fotos de estadios = Wikimedia Commons (CC / dominio público), igual que el
// resto del sitio (data/stadiums.json, sección biblia). Antes eran JPG reales
// auto-alojados sin licencia ni crédito (riesgo de copyright para AdSense).
// Crédito visible bajo la imagen ("Foto: Wikimedia Commons").
const STADIUM_IMAGES: Record<string, string> = {
  'nueva-york': 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Meadowlands_Stadium_panorama.jpg/960px-Meadowlands_Stadium_panorama.jpg',
  'los-angeles': 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/September_2017_aerial_view_of_the_construction_site_of_the_Los_Angeles_Stadium_at_Hollywood_Park.png/960px-September_2017_aerial_view_of_the_construction_site_of_the_Los_Angeles_Stadium_at_Hollywood_Park.png',
  'miami': 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Dolphin_Stadium_baseball_diamond.jpg/960px-Dolphin_Stadium_baseball_diamond.jpg',
  'dallas': 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Cowboys_inside_front_view.JPG/960px-Cowboys_inside_front_view.JPG',
  'san-francisco': 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Santa_Clara_Stadium_1765_02.JPG/960px-Santa_Clara_Stadium_1765_02.JPG',
  'seattle': 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Century_Link_Field_%28Seattle%2C_Washington%29.jpg/960px-Century_Link_Field_%28Seattle%2C_Washington%29.jpg',
  'atlanta': 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Mercedes-Benz_Stadium_Pedestrian_Bridge.jpg/960px-Mercedes-Benz_Stadium_Pedestrian_Bridge.jpg',
  'houston': 'https://upload.wikimedia.org/wikipedia/commons/a/a7/PictureofReliantStadium.jpg',
  'filadelfia': 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/LincolnFinancialFieldsat.png/960px-LincolnFinancialFieldsat.png',
  'boston': 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Gillette_Stadium2.jpg/960px-Gillette_Stadium2.jpg',
  'kansas-city': 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/34/Kansas_City_Arrowhead_Stadium.jpg/960px-Kansas_City_Arrowhead_Stadium.jpg',
  'ciudad-de-mexico': 'https://upload.wikimedia.org/wikipedia/commons/6/65/Estadio_azteca.jpg',
  'guadalajara': 'https://upload.wikimedia.org/wikipedia/commons/1/1e/Volcano_stadium.png',
  'monterrey': 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Estadio_BBVA_Bancomer.jpg/960px-Estadio_BBVA_Bancomer.jpg',
  'toronto': 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Approaching-BMO-Field.jpg/960px-Approaching-BMO-Field.jpg',
  'vancouver': 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/BC_Place_inflated_roof_inside.jpg/960px-BC_Place_inflated_roof_inside.jpg',
};
