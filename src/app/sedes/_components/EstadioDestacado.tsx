    ...
    >
      ...
      <div className="relative h-64 overflow-hidden md:h-72">
        {imageUrl ? (
          ...
          <div className="h-full w-full bg-gradient-to-br from-[#14110a] to-[#1b160d]" />
        )}
      ...
      <div className="absolute inset-x-0 bottom-0 p-5 md:p-6">
        ...
        <span
          ...
          style={{ background: badgeColor, color: badgeColor === '#c9a84c' ? '#000000' : '#fff' }}
        >
          {badge}
        </span>
        ...
        <p className="mb-3 text-base text-[#a69a82]">{sede.estadio}</p>

        {/* Stats */}
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-[#6e6552]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
            <div>
              <p className="text-xs text-[#6e6552]">{sT.capacidad}</p>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xs text-[#6e6552]">{sT.partidos}</p>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xs text-[#6e6552]">{sT.clima}</p>
