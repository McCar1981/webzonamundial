...
export default function ZonaFutbolPreviewPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#000000] via-[#000000] to-[#000000] text-[#E2E8F0]" style={{fontFamily: "'Outfit', system-ui, sans-serif"}}>
      ...
      <section className="py-16 sm:py-20 px-3 sm:px-4 relative bg-gradient-to-b from-[#000000] via-[#000000]/40 to-[#14110a]/30" role="region" aria-label="Sobre Zona Futbol">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div>
                <h2 className="font-black text-2xl sm:text-3xl text-white mb-4">La Misma Pasión, Ahora con Tu Liga</h2>
                <p className="text-sm sm:text-base text-[#e6decb] leading-relaxed">
              ...
              <div className="space-y-3">
                <div className="flex gap-3">
                  ...
                  <span className="text-sm text-[#e6decb]"><strong>Tu progreso se migra:</strong> Puntos, logros, historial de predicciones</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-[#D4AF37] font-black">•</span>
                  <span className="text-sm text-[#e6decb]"><strong>Bonus de fundador:</strong> Recompensas extras para migraciones tempranas</span>
                </div>
                <div className="flex gap-3">
                  <span className="text-[#D4AF37] font-black">•</span>
                  <span className="text-sm text-[#e6decb]"><strong>Experiencia sin interrupciones:</strong> Continúa donde lo dejaste</span>
                </div>
              </div>
            </div>

            <div className="p-8 rounded-2xl bg-gradient-to-br from-[#14110a]/70 via-[#000000]/50 to-transparent border border-[#D4AF37]/30 hover:border-[#D4AF37]/60 transition-all duration-300 shadow-xl">
              <h4 className="font-black text-sm text-[#D4AF37] uppercase tracking-wider mb-4">Tu Progreso se Transfiere Así</h4>
              <div className="space-y-3 text-sm text-[#e6decb]">
                ...
                <p className="text-xs text-[#a69a82] mt-2">*El ranking se reinicia cada temporada para todos</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 px-3 sm:px-4 relative bg-gradient-to-b from-[#14110a]/30 via-[#000000]/40 to-[#000000]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              return (
                <div key={idx} className="p-5 sm:p-6 rounded-xl bg-gradient-to-br from-[#14110a]/50 via-[#000000]/30 to-transparent backdrop-blur-sm border border-[#D4AF37]/20 hover:border-[#D4AF37]/60 transition-all duration-300 text-center group cursor-pointer">
                  ...
                  <div className="text-xs sm:text-sm text-[#a69a82] mt-2">{stat.label}</div>
                </div>
              );
            })}
          </div>
      ...
      {/* LIGAS — Premium Cards */}
      <section className="py-24 sm:py-32 px-3 sm:px-4 relative bg-gradient-to-b from-[#000000]/50 via-[#14110a]/30 to-[#000000]" role="region" aria-label="Ligas">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <SectionCard>
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-4 text-center">
                    ...
                    {league.games && league.players && (
                      <div className="mt-2 space-y-1 text-xs animate-fade-in opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="text-[#e6decb]">{league.games} partidos</div>
            ...
            {/* Stats Summary */}
            <div className="mt-16 grid grid-cols-2 gap-6 p-8 sm:p-10 rounded-3xl bg-gradient-to-br from-[#14110a]/70 via-[#000000]/50 to-[#000000] border border-[#D4AF37]/25 shadow-2xl hover:border-[#D4AF37]/50 transition-all duration-300">
              <div className="text-center group">
                ...
                <div className="text-xs sm:text-sm text-[#a69a82] mt-2">Ligas Disponibles</div>
              </div>
              <div className="text-center group">
                ...
                <div className="text-xs sm:text-sm text-[#a69a82] mt-2">Partidos Anuales</div>
              </div>
            </div>
          </SectionCard>
        </div>
      ...
      <section className="py-24 sm:py-32 px-3 sm:px-4 relative bg-gradient-to-b from-[#14110a]/40 via-[#000000] to-[#000000]/50" role="region" aria-label="Funcionalidades">
              ...
              {FEATURES.map((feature, idx) => {
                ...
                return (
                  <Link key={feature.id} href={`#${feature.id}`} style={{animationDelay: `${idx * 0.1}s`}} className="group relative overflow-hidden rounded-2xl p-8 backdrop-blur-xl transition-all duration-300 hover:shadow-2xl cursor-pointer shadow-xl border border-[#D4AF37]/20 hover:border-[#D4AF37]/60 active:scale-95 bg-gradient-to-br from-[#14110a]/60 via-[#000000]/40 to-transparent hover:from-[#14110a]/80 hover:to-[#D4AF37]/10 block">
                    ...
                    <p className="text-sm text-[#e6decb] leading-relaxed tracking-wide group-hover:text-white transition-colors duration-300">
                      {feature.desc}
                    </p>
            ...
            <div className="mt-12 p-8 sm:p-10 rounded-2xl bg-gradient-to-r from-[#D4AF37]/15 to-[#D4AF37]/5 border border-[#D4AF37]/30 hover:border-[#D4AF37]/60 transition-all duration-300 shadow-xl">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-sm text-[#e6decb] leading-relaxed">
      ...
      <section id="como-funciona" className="py-24 sm:py-32 px-3 sm:px-4 relative bg-gradient-to-b from-[#000000] via-[#000000]/40 to-[#000000]" role="region" aria-label="Cómo jugar">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <SectionCard variant="solid">
              ...
              {STEPS.map((step, idx) => {
                ...
                return (
                  <div key={step.number} className="group relative">
                    <div className="p-8 rounded-2xl bg-gradient-to-br from-[#14110a]/70 via-[#000000]/50 to-transparent hover:from-[#14110a]/90 hover:via-[#000000]/70 border border-[#D4AF37]/20 hover:border-[#D4AF37]/60 transition-all duration-300 hover:shadow-2xl cursor-pointer active:scale-95 relative overflow-hidden">
                      ...
                      <div className="relative z-10 space-y-4">
                        <div className="flex items-center gap-4">
                          <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#ffc266] text-[#000000] font-black text-2xl group-hover:scale-125 group-hover:shadow-[0_0_24px_rgba(212,175,55,0.6)] transition-all duration-300 shadow-lg">
                            {step.number}
                          </div>
                      ...
                      <div className="pt-4 border-t border-[#D4AF37]/20 group-hover:border-[#D4AF37]/60 transition-all duration-300">
                        <div className="flex items-baseline gap-2 pt-3" aria-live="polite">
                          ...
                          <span className="text-xs text-[#a69a82] font-bold">{step.suffix}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  {idx < STEPS.length - 1 && (
                    <div className="hidden sm:block absolute -right-4 top-14 w-8 h-8 bg-[#D4AF37] rounded-full border-4 border-[#000000] shadow-lg group-hover:shadow-[0_0_16px_rgba(212,175,55,0.6)] transition-shadow duration-300" />
                  )}
                </div>
                );
              })}
            ...
            <div className="mt-12 space-y-6">
              <div className="p-8 rounded-2xl bg-[#14110a]/50 border border-[#D4AF37]/20 shadow-xl">
                <p className="text-base text-[#e6decb] leading-relaxed tracking-wide">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  return (
                    <div key={i} className="p-4 rounded-xl bg-[#14110a]/50 border border-[#D4AF37]/20 text-center hover:border-[#D4AF37]/60 hover:bg-[#14110a]/70 transition-all duration-300 group cursor-pointer">
                      ...
                      <p className="text-xs text-[#a69a82]">{benefit.desc}</p>
                    </div>
                  );
                })}
              </div>
      ...
      <section className="py-20 sm:py-28 px-3 sm:px-4 relative bg-gradient-to-b from-[#000000] via-[#000000]/40 to-[#14110a]/30" role="region" aria-label="Próximo partido destacado">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-black text-2xl sm:text-3xl text-white mb-2">Haz tu Predicción</h2>
            <p className="text-sm sm:text-base text-[#e6decb]">Cada partido es una oportunidad de ganar puntos y premios</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Featured Match */}
            <div className="lg:col-span-2 p-8 sm:p-10 rounded-2xl bg-gradient-to-br from-[#14110a]/80 via-[#000000]/60 to-transparent border border-[#D4AF37]/40 hover:border-[#D4AF37]/70 transition-all duration-300 shadow-2xl">
              <div className="text-center space-y-6">
                <div className="text-xs font-black text-[#a69a82] uppercase tracking-wider">Jornada 25 • Premier League</div>
                ...
                <div className="grid grid-cols-3 gap-4 items-center">
                  ...
                  <div className="text-center">
                    <div className="text-4xl font-black text-[#a69a82]">—</div>
                    <div className="text-xs font-black text-[#a69a82] mt-2">EN VIVO</div>
                  </div>
                ...
                <div className="space-y-3 pt-4">
                  <p className="text-xs text-[#a69a82]">¿Cuál será el resultado final?</p>
                  <div className="grid grid-cols-3 gap-3">
                    {["Victoria MAN CITY", "Empate", "Victoria ARSENAL"].map((pred, i) => (
                      <button key={i} className="py-3 px-4 rounded-lg bg-[#14110a]/60 border border-[#D4AF37]/30 hover:border-[#D4AF37]/70 hover:bg-[#D4AF37]/15 text-xs sm:text-sm font-black text-white transition-all duration-300 active:scale-95">
                        {pred}
                      </button>
                    ))}
                  </div>
                ...
                <div className="pt-4 text-xs text-[#a69a82]">
            ...
            <div className="space-y-3">
              ...
              {[
                ...
                <button key={i} className="w-full p-4 rounded-lg bg-[#14110a]/50 hover:bg-[#14110a]/70 border border-[#D4AF37]/20 hover:border-[#D4AF37]/60 transition-all duration-300 text-left group cursor-pointer">
                  <div className="text-xs text-[#a69a82] font-black mb-2">{match.time} • {match.league}</div>
                  <div className="text-sm font-black text-white group-hover:text-[#D4AF37]">{match.home}</div>
                  <div className="text-xs text-[#e6decb] mt-1">vs {match.away}</div>
                </button>
              ))}
      ...
      {/* IMPACT STATS */}
      <section className="py-20 sm:py-28 px-3 sm:px-4 relative bg-gradient-to-b from-[#000000] via-[#000000] to-[#000000] overflow-hidden">
        <div className="absolute inset-0 opacity-30 pointer-events-none">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8">
            {[
              ...
              const Icon = stat.Icon;
              return (
                <div key={idx} className="p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-[#14110a]/60 via-[#000000]/40 to-transparent backdrop-blur-xl border border-[#D4AF37]/25 hover:border-[#D4AF37]/60 transition-all duration-300 text-center hover:shadow-2xl group cursor-pointer">
                  ...
                  <div className="text-xs sm:text-sm text-[#a69a82] font-medium">{stat.label}</div>
                </div>
              );
            })}
          </div>
      ...
      {/* PWA INSTALLATION */}
      <section className="py-20 sm:py-28 px-3 sm:px-4 relative bg-gradient-to-b from-[#000000] via-[#14110a]/30 to-[#000000]">
        <div className="max-w-7xl mx-auto">
          <SectionCard>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              {[
                ...
                return (
                  <div key={i} className="p-6 rounded-xl bg-[#14110a]/50 border border-[#D4AF37]/20 hover:border-[#D4AF37]/60 text-center transition-all duration-300 group cursor-pointer">
                    <div className="mb-3 group-hover:scale-125 transition-transform duration-300 flex justify-center">
            ...
            <div className="mt-12 text-center">
              <button className="px-8 py-4 rounded-lg bg-gradient-to-r from-[#D4AF37] to-[#ffc266] text-[#000000] font-black hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all duration-300 active:scale-95">
                Instalar App
              </button>
              <p className="text-xs text-[#a69a82] mt-4">Compatible con iOS, Android y navegador</p>
            </div>
          </SectionCard>
        </div>
      </section>
      ...
      {/* EMAIL SIGNUP */}
      <section className="py-16 sm:py-20 px-3 sm:px-4 relative bg-gradient-to-b from-[#000000] via-[#000000]/40 to-[#14110a]/20">
        <div className="max-w-2xl mx-auto">
          <div className="p-8 sm:p-10 rounded-2xl bg-gradient-to-br from-[#14110a]/70 via-[#000000]/50 to-transparent border border-[#D4AF37]/30 hover:border-[#D4AF37]/50 transition-all duration-300 shadow-xl">
            <h3 className="font-black text-xl sm:text-2xl text-white text-center mb-2">No te Pierdas Nada</h3>
            <p className="text-sm text-[#e6decb] text-center mb-6">Suscríbete y recibe alertas de convocatorias, lesiones, resultados y análisis de IA</p>

            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <input
                type="email"
                placeholder="tu@email.com"
                className="flex-1 px-4 py-3 rounded-lg bg-[#000000] border border-[#D4AF37]/30 text-white placeholder-[#a69a82] focus:border-[#D4AF37] focus:outline-none transition-all duration-300"
              />
              <button className="px-6 py-3 rounded-lg bg-[#D4AF37] text-[#000000] font-black hover:bg-[#ffc266] transition-all duration-300 active:scale-95">
                Suscribirse
              </button>
            </div>

            <p className="text-xs text-center text-[#a69a82]">
          ...
          <SectionCard variant="accent">
            <div className="text-center space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg sm:text-xl text-[#e6decb] max-w-lg mx-auto leading-relaxed tracking-wide drop-shadow">
              ...
              {/* Feature Highlights */}
              <div className="grid grid-cols-3 gap-3 sm:gap-4 px-4 py-6 rounded-xl bg-[#14110a]/60 border border-[#D4AF37]/25 backdrop-blur-xl hover:border-[#D4AF37]/60 transition-all duration-300">
                <div className="text-center group">
                  <Lightning className="w-6 h-6 sm:w-7 sm:h-7 mx-auto text-[#D4AF37] group-hover:text-[#ffc266] transition-colors" />
                  <p className="text-xs text-[#a69a82] mt-2 group-hover:text-[#e6decb]">5 min para jugar</p>
                </div>
                <div className="text-center border-l border-r border-[#D4AF37]/25 group">
                  ...
                  <p className="text-xs text-[#a69a82] mt-2 group-hover:text-[#e6decb]">Sin experiencia</p>
                </div>
                <div className="text-center group">
                  <CheckCircle className="w-6 h-6 sm:w-7 sm:h-7 mx-auto text-[#D4AF37] group-hover:text-[#ffc266] transition-colors" />
                  <p className="text-xs text-[#a69a82] mt-2 group-hover:text-[#e6decb]">Instantáneo</p>
                </div>
              </div>
              ...
              {/* Trust Badges */}
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4 text-xs text-[#a69a82]">
      ...
      {/* FOOTER */}
      <footer className="border-t border-[#D4AF37]/20 py-12 sm:py-16 px-3 sm:px-4 bg-gradient-to-b from-[#000000] to-[#000000]" role="contentinfo">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-12">
            <div className="space-y-4">
              <h3 className="font-black text-lg text-white tracking-tight">Zona Futbol</h3>
              <p className="text-xs sm:text-sm text-[#a69a82] leading-relaxed">Fantasía de ligas, predicciones, duelos, minijuegos y premios reales. Hecho para fans.</p>
              <p className="text-xs text-[#a69a82]">Powered by <span className="text-[#D4AF37] font-black">Sprintmarkt</span></p>
            </div>

            <nav className="space-y-3">
              <h4 className="font-black text-xs text-white uppercase tracking-wider mb-4">Torneo</h4>
              <ul className="space-y-2 text-xs sm:text-sm text-[#a69a82]">
          ...
          <div className="py-6 border-t border-b border-[#D4AF37]/20">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-xs sm:text-sm text-[#a69a82]">
              <span>Síguenos:</span>
          ...
          <div className="mt-8 space-y-3 text-center text-xs text-[#a69a82]">
            <p>
