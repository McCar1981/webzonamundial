...
export const CREADORES: Creador[] = [
  ...
  {
    slug: 'salvador',
    nombre: 'Salvador Otero',
    seguidores: '233K',
    seguidoresNum: 233000,
    colorPrimario: '#F97316',
    colorSecundario: '#FB923C',
    emoji: '',
    plataformaPrincipal: 'TikTok',
    bio: 'Periodista deportivo: viajes, estadios y fútbol modesto, con el Mundial por bandera.',
    contenido: 'Viajes, estadios, fútbol modesto y Mundial',
    paisFlag: 'es',
    pais: 'España',
    imagen: CREADORES_IMGS.salvador,
    handle: '@salvadoroterogk',
    redes: [
      { plataforma: 'tiktok', url: 'https://www.tiktok.com/@salvadoroterogk', usuario: '@salvadoroterogk' },
      { plataforma: 'instagram', url: 'https://www.instagram.com/salvadoroterogk', usuario: '@salvadoroterogk' },
    ],
  },
  {
    slug: 'niku',
    nombre: 'Niku',
    seguidores: '339K',
    seguidoresNum: 339000,
    colorPrimario: '#F43F5E',
    colorSecundario: '#FB7185',
    emoji: '',
    plataformaPrincipal: 'TikTok',
    bio: 'Creador de contenido de fútbol en TikTok e Instagram.',
