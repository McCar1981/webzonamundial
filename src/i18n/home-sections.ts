...
export const homeSections = {
  es: {
    ...
    /* ============ WaitlistSection ============ */
    waitlist: {
      pill: "Novedades del Mundial",
      title1: "No te pierdas",
      titleGold: "ni un partido.",
      descBefore: "Suscríbete gratis y recibe los",
      descHighlight: "avisos y novedades",
      descAfter: "del Mundial en tu correo.",
      benefits: [
        "Avisos de los partidos clave",
        "Novedades y sorteos",
        "Lo mejor del Mundial cada día",
      ],
      formTitle: "SUSCRÍBETE GRATIS A LAS NOVEDADES",
      emailPlaceholder: "Tu email",
      submit: "Suscribirme gratis",
      submitting: "Enviando...",
      assurance: "Sin spam. Sin compromiso. Solo fútbol.",
      counterLabel: "aficionados ya suscritos",
      counterLabelJoined: "ya reciben las novedades",
      successTitle: "¡Suscrito!",
      successMsg:
        "Te enviaremos los avisos de los partidos y las novedades del Mundial. Mientras, entra y empieza a jugar gratis.",
  ...
  en: {
    ...
    waitlist: {
      pill: "World Cup updates",
      title1: "Never miss",
      titleGold: "a match.",
      descBefore: "Subscribe free and get",
      descHighlight: "alerts and news",
      descAfter: "from the World Cup in your inbox.",
      benefits: [
        "Alerts for key matches",
        "News and giveaways",
        "The best of the World Cup daily",
      ],
      formTitle: "SUBSCRIBE FREE FOR UPDATES",
      emailPlaceholder: "Your email",
      submit: "Subscribe free",
      submitting: "Sending...",
      assurance: "No spam. No strings attached. Just football.",
      counterLabel: "fans already subscribed",
      counterLabelJoined: "already get the updates",
      successTitle: "Subscribed!",
      successMsg: "We'll send you match alerts and World Cup news. Meanwhile, jump in and start playing for free.",
